...
#define HX_UINT16_FROM_BE(v)  HX_UINT16_TO_BE (v)
#define HX_UINT32_FROM_BE(v)  HX_UINT32_TO_BE (v)
#define HX_UINT64_FROM_BE(v)  HX_UINT64_TO_BE (v)
...
#define HX_INT16_TO_BE(v)     ((hx_int16) HX_UINT16_TO_BE ((hx_uint16) (v)))
#define HX_INT32_TO_BE(v)     ((hx_int32) HX_UINT32_TO_BE ((hx_uint32) (v)))
#define HX_INT64_TO_BE(v)     ((hx_int64) HX_UINT64_TO_BE ((hx_uint64) (v)))
#define HX_INT16_FROM_BE(v)   HX_INT16_TO_BE (v)
#define HX_INT32_FROM_BE(v)   HX_INT32_TO_BE (v)
#define HX_INT64_FROM_BE(v)   HX_INT64_TO_BE (v)
